...
const RDListAssignedPlan = () => {
    ...
    useEffect(() => {
        if (projectId) {
            ...
            // these attributes are wrong since you can't actually have instances of an assigned plan itself,
...
export default RDListAssignedPlan;